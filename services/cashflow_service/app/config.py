"""Configuration for the Cash Flow service — loaded from environment."""
...
@dataclass
class Settings:
    dynamodb_table_name: str = "rural-credit-cashflow"
    ...
    def from_env() -> Settings:
        return Settings(
            dynamodb_table_name=os.getenv("DYNAMODB_TABLE_NAME", "rural-credit-cashflow"),
